...
namespace GestaoDeEstacionamento.Infraestrutura.Orm.Migrations
{
    ...
    [Migration("20250923142850_Config_Geral")]
    partial class Config_Geral
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoDeEstacionamento.Core.Dominio.ModuloVaga.Vaga", b =>
                {
                    b.HasOne("GestaoDeEstacionamento.Core.Dominio.ModuloTicket.Ticket", null)
                        .WithOne("Vaga")
                        .HasForeignKey("GestaoDeEstacionamento.Core.Dominio.ModuloVaga.Vaga", "TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
